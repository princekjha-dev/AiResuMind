...
def render_feature_cards_grid():
    ...
    features = [
        ...
        {
            "tag": "03",
            "title": "AI Cover Letter & Outreach",
            "description": "Generate personalized cover letters, recruiter cold emails, LinkedIn DMs, and post-interview follow-ups."
        },
        {
            "tag": "04",
...
def render_pricing_section():
    ...
    plans = [
        ...
        {"name": "Pro Executive", "price": "$19", "period": "per month", "desc": "Full suite for serious candidates", "features": ["Unlimited AI Resume Analyses", "94%+ ATS Keyword Optimization", "AI Cover Letter & Outreach Suite", "AI Mock Interview Prep Engine", "Job Search & Salary Insights"], "cta": "Start Pro Trial", "popular": True},
...
def render_faq_section():
    ...
    faqs = [
        ...
        ("Can I generate job-specific cover letters and recruiter DMs?", "Yes. The AI Outreach Suite generates custom cover letters, recruiter cold emails, LinkedIn connection requests, and interview follow-up emails tailored to your target job description."),
